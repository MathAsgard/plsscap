...
import HeartFundCard from "./HeartFundCard";
import farms from "../../../config/constants/farmsRh.js";

let farmsArray = JSON.parse(JSON.stringify(farms));
let farmsFilters = {};

const HeartFundSection = () => {
      ...
      <div className="container">
        <div className="flex flex-wrap justify-center gap-5 items-center mb-8 md:mb-[46px]">
          ...
          <div className="bg-gradient9 rounded-full p-[1px]">
            <div
              className={`flex flex-wrap gap-x-2 sm:gap-x-0 gap-y-2 items-center rounded-full relative z-10  ${
                view === "grid"
...
const data = [{ native: true }, { native: true }, { native: true }];

export default HeartFundSection;
